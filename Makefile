#############################################################################
# Makefile for building: libSFGL.so.1.0.0
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  SFGL.pro
# Template: lib
# Command: /home/rootming/Qt5.5.1/5.5/gcc_64/bin/qmake -o Makefile SFGL.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/rootming/Qt5.5.1/5.5/gcc_64 -shared -Wl,-soname,libSFGL.so.1
LIBS          = $(SUBLIBS) -lpthread -lpng12 -lz -lfreetype 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
TARGET        = libSFGL.so.1.0.0
TARGETA       = libSFGL.a
TARGET0       = libSFGL.so
TARGETD       = libSFGL.so.1.0.0
TARGET1       = libSFGL.so.1
TARGET2       = libSFGL.so.1.0
